...
from wbuild.utils import parseWBInfosFromScriptFiles, parseWBInfosFromScriptFile, parseMDFiles, getYamlParam, pathsepsToUnderscore, \
...
def writeWBParseDependencyFile(filename):
    ...
    conf = Config()
    htmlOutputPath = conf.get("htmlOutputPath")
    wbData = parseWBInfosFromScriptFile(filename=filename, htmlPath=htmlOutputPath)
